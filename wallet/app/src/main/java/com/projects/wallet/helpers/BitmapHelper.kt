...
object BitmapHelper {
    ...
    fun save(name: String, bitmap: Bitmap, context: Context) {
        val outStreamFile = FileOutputStream(File(context.filesDir.absolutePath + "/$name.png"))
        bitmap.compress(Bitmap.CompressFormat.PNG, 100, outStreamFile)
    }
    ...
    fun getBitmapFromUri(contentResolver : ContentResolver, uri: Uri): Bitmap {
        val parcelDescriptor: ParcelFileDescriptor? = contentResolver.openFileDescriptor(uri, "r")
        val fileDescriptor: FileDescriptor = parcelDescriptor!!.fileDescriptor
