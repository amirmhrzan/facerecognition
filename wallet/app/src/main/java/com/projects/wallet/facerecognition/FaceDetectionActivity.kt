...
import com.projects.wallet.helpers.AnalyseFrame
import com.projects.wallet.helpers.BitmapHelper
import com.projects.wallet.helpers.BoxBounding
import com.projects.wallet.helpers.ReadImages
import kotlinx.android.synthetic.main.activity_authenticate_faces.*
...
class FaceDetectionActivity : AppCompatActivity() {
    ...
    private lateinit var analyseFrame  : AnalyseFrame
    private lateinit var model : FaceNetModel
    private lateinit var readImages : ReadImages
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_authenticate_faces)
        ...
        val boundingBoxOverlay = findViewById<BoxBounding>( R.id.bbox_overlay )
        boundingBoxOverlay.setWillNotDraw( false )
        boundingBoxOverlay.setZOrderOnTop( true )

        analyseFrame = AnalyseFrame( this , this,boundingBoxOverlay)
        model = FaceNetModel( this )
        readImages = ReadImages( this )
        ...
        isSerializedDataStored = sharedPreferences.getBoolean( SHARED_PREF_IS_DATA_STORED_KEY , false )
            ...
            lifecycleScope.launch {
                ...
                if ( !errorFound ) {
                    readImages.run( images , readImagesCallback )
    ...
    private fun bindPreview(cameraProvider : ProcessCameraProvider) {
        ...
        val imageFrameAnalysis = ImageAnalysis.Builder()
            ...
            .build()
        imageFrameAnalysis.setAnalyzer(Executors.newSingleThreadExecutor(), analyseFrame )
    ...
    private fun getFixedBitmap( imageFileUri : Uri) : Bitmap {
        var imageBitmap = BitmapHelper.getBitmapFromUri( contentResolver , imageFileUri )
        ...
        imageBitmap =
            when (exifInterface.getAttributeInt( ExifInterface.TAG_ORIENTATION ,
                ...
                ExifInterface.ORIENTATION_ROTATE_90 -> BitmapHelper.rotate( imageBitmap , 90f )
                ExifInterface.ORIENTATION_ROTATE_180 -> BitmapHelper.rotate( imageBitmap , 180f )
                ExifInterface.ORIENTATION_ROTATE_270 ->  BitmapHelper.rotate( imageBitmap , 270f )
                else -> imageBitmap
            }
        return imageBitmap
    }
