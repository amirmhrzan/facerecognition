...
import com.projects.wallet.facerecognition.FaceNetModel
...
class ReadImages( private var context: Context) {
    ...
    // used by the AnalyseFrame class.
    ...
    private fun scanImage( name : String , image : Bitmap) {
        val inputImage = InputImage.fromByteArray(
            BitmapHelper.bitmapToNV21ByteArray( image ) ,
            image.width,
            image.height,
            0,
